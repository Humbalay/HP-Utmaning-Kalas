...
const resultWords = ["abborre", "afton", "alster", "ansats", "arvode", "avstamp", "balans", "barrskog", "begrepp", "besked", "betraktelse", "blomning", "boplats", "bråddjup", "bäck", "dager", "dallring", "dunge", "eftertanke", "eldstad", "famn", "fjärran", "flöde", "föraning", "försprång", "gryning", "gäspning", "havsbris", "hågkomst", "höstlöv", "inblick", "klang", "klinga", "klöver", "krusning", "källa", "lindring", "ljusglimt", "mellanrum", "morgonrodnad", 
                     "nigga", "Svep en öl", "Ta en shot", "Ta 5 klunkar", "Ta någons näsa", "Ta någons näsa", "Tvinga någon ny att spela", "Tvinga någon ny att spela", "Tvinga någon ny att spela", "Gör en drink och ge bort", "Tvinga någon ny att spela", "Ta en shot", "Ta en shot", "Ta en shot", "Ta 3 klunkar", "Ta 2 klunkar", "Dela ut 5", "Dela ut 3", "Hämta en ny öl till Jesper", "Dela ut 2", "Drick antal rätt", "Ge förstaplatsen en high five", "Ge förstaplatsen en high five", "Få alla att skåla!!", "Ta en klunk", "Ta 5 klunkar", "Ta 5 klunkar", "Ge en shot", "Skåla med nån", "Häll vatten på närmaste Födelsedagsbarn", "Drick med vänster", "Drick med höger", "Häll vatten på närmaste Födelsedagsbarn", "Skål för livet", "Drick antal rätt", "Ta en halv öl", "Ge bort 5", "Ge bort 5", "Drick ikapp", "cookface", "Fuck Denmark", "Usel insats", "nyans", "närvaro", "omväg", "ordflöde", "perspektiv", "rand", "resning", "rörelse", "samsyn", "skymning", "stjärnfall", "stråk", "susning", "svall", "tanke", "tillförsikt", "tjärn", "utsikt", "vingslag", "vårvind", "vägskäl", "återsken", "ängsmark", "överblick"];
